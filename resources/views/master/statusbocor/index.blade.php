            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <a class="btn btn-primary" href="{{ url('statusbocor/tambah') }}" style="float: left;"> + Tambah
                            Status</a>
                    </div>
                                ...
                                @foreach ($statusbocor as $item)
                                    <tr>
                                        ...
                                        @elseif ($item->status == 3)
                                            <td>
                                                <div class="alert alert-info" role="alert"> Siaga</div>
                                            </td>
                                        @elseif ($item->status == 4)
                                            <td>
                                                <div class="alert alert-warning" role="alert"> Awas</div>
                                            </td>
                                        @else
                                            <td>
