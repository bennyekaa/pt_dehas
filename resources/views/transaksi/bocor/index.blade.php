                                            ...
                                            <div class="btn-group">
                                                @if (session('role') == 0)
                                                    <a class="btn btn-primary" title="Kirim Ke Balai"
                                                        href="{{ url('transaksi/bocor/kirim') }}/{{ encrypt($item->id_banjir_bocor) }}">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item"
                                                                href="{{ url('transaksi/bocor/pesan') }}/{{ encrypt($item->id_banjir_bocor) }}/2"
                                                                title="Kirim Ke Bupati">Bupati</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('transaksi/bocor/pesan') }}/{{ encrypt($item->id_banjir_bocor) }}/3">BPPD</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('transaksi/bocor/pesan') }}/{{ encrypt($item->id_banjir_bocor) }}/4">PENDUDUK</a>
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
