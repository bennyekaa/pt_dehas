            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/desa/tambahproses" method="post">
                        ...
                        <div class="row mb-3">
                            <label for="tk_long" class="col-md-4 col-form-label text-md-end">{{ ('Titik Kumpul Longitude') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="e_long" class="col-md-4 col-form-label text-md-end">{{ ('Evakuasi Longitude') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="e_lat" class="col-md-4 col-form-label text-md-end">{{ ('Evakuasi Latitude') }}</label>
                            <div class="col-md-6">
