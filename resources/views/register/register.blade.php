                ...
                <div class="card-body">
                    <form action="/user/store" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('username') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <select type="jabatan" class="col-md-6 form-control" name="jabatan" id="role">
